...
const Home = () => {
  ...
  return (
    <RootLayout pageTitle={pageTitle} pageDescription={pageDescription}>
      <main className="w-screen h-screen flex items-center justify-center bg-red-700 text-white">
        <div className="text-center px-8 max-w-6xl">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold uppercase mb-10">
            ⚠️ ATTENTION !
          </h1>

          <p className="text-2xl md:text-4xl lg:text-5xl font-semibold leading-relaxed">
            Ce site est fermé.
            <br /><br />
            M. MIQUEL ne paie pas ses factures.
          </p>
        </div>
      </main>
    </RootLayout>
...
//         <h1 className="text-6xl font-bold mb-4">ATTENTION ! A EVITER !!</h1>
