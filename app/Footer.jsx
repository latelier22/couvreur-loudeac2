...
<footer className="bg-black text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200">
  ...
  <h5 className="mb-2 text-white font-bold uppercase">Une fuite ou une fissure dans votre toiture ?</h5>
...
<img
  ...
  <ul className="mb-0 list-none">
    {menuItems.map((menuItem, index) => (
      <li key={index}>
        <a href={menuItem.route} className="text-neutral-600 hover:text-neutral-800 dark:text-neutral-200">
          {menuItem.label}
        </a>
      </li>
    ))}
...
<div className="mb-7 flex justify-center gap-x-5">
        {photoFooter.map((photo, index) => (
          <div key={index} className="relative w-full overflow-hidden bg-cover bg-no-repeat rounded-lg">
